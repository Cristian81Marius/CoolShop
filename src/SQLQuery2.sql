...
INSERT INTO Products (Id,Name, DefaultPrice, Currency, Description, SupplierId,CategoryId,ImageUrl,Amount) VALUES (5, 'Chass', 101.0, 'RON', 'Joaca ca un profesionist - sau petrece timp cu prietenii si familia - cu acest set de calitate lucrat 100% cu mana care include 2 jocuri populare intr-un singur set - sah pe partea exterioara vopsita, lacuita si gravata cu linii pentru patratele si decoratiuni florale, table in partea interioara vopsita si lacuita a tablei de joc.',1,1,'https://handmadein.ro/wp-content/uploads/2021/12/44fbanp8-768x477.jpg',10);
